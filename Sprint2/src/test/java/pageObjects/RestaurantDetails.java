...
WebDriver driver;
	...
	public RestaurantDetails(WebDriver driver) {
	    ...
	    //private By selecttime1=By.xpath("div[@class='_8a6d6d85 _6f29c471']");
		...
		public void getDate() {
	       ...
	       WebElement date=driver.findElement(By.xpath("//div[@aria-label='Tue, Dec 15, 2020']"));
	       date.click();
		}
